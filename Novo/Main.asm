...
queijo:					#checa qual foi o input e vai para a funï¿½ï¿½o correspondente
	...
	beq $11 ' ' 	picles
	j alface
cebola:					#Se está na primeira tela e vai para a esquerda, move $9 para a última tela
	add  $13 $0  $14
	addi $14 $14 -1
	mul  $25 $15  $14 
	addi $14 $14  1
...
alho:					#Se está na última tela e vai para a direita, move $9 para a primeira tela
	addi $9 $9 	-3538944
	addi $13 $0 1
	j mortadela
...
hamburguer:				#vai para a próxima tela
